...
?>
<?php query_posts('cat=66,67,-144,-58,-70,-71,-72,-73,-74,-184&showposts=-1'); ?>
...
<td>	<?php 
  ...
  <?php rewind_posts(); ?>
<?php query_posts('cat=66,67,-144,-58,-70,-71,-72,-73,-75,-184&showposts=-1'); ?>
...
foreach((get_the_category()) as $category) { 
  ...
  <?php rewind_posts(); ?>
<?php query_posts('cat=66,67,-144,-58,-70,-71,-72,-74,-75,-184&showposts=-1'); ?>
...
foreach((get_the_category()) as $category) { 
	...
	<?php endif; ?>
  <?php rewind_posts(); ?>
<?php query_posts('cat=66,67,-144,-58,-70,-71,-73,-74,-75,-184&showposts=-1'); ?>
...
foreach((get_the_category()) as $category) { 
	...
	<?php endif; ?>
  <?php rewind_posts(); ?>
<?php query_posts('cat=66,67,-144,-58,-70,-72,-73,-74,-75,-184&showposts=-1'); ?>
...
foreach((get_the_category()) as $category) { 
	...
	<?php endif; ?>
  <?php rewind_posts(); ?>
<?php query_posts('cat=66,67,-144,-58,-71,-72,-73,-74,-75,-184&showposts=-1'); ?>
...
foreach((get_the_category()) as $category) { 
  ...
  <?php rewind_posts(); ?>
<?php query_posts('cat=66,67,-144,-58,-71,-72,-73,-74,-75,-70&showposts=-1'); ?>
