<?php /*
Template Name: Transferir a Rocío
*/
?>
<?php get_header( ); ?>
...
// INSERT luis category->ID 

 $taxonomy_wait = $wpdb->get_var("SELECT term_taxonomy_id from $wpdb->term_taxonomy WHERE term_id = 144");
...
// Y ahora enviamos un correo de notificación
	...
	$comment_author_domain = @gethostbyaddr($comment->comment_author_IP);
			...
			$notify_message .= '<strong>Ticket traspasado: '.$user_identity.' -> Rocío</strong><br />';
...
Ticket transferido a Rocío

<br /><br />

Redireccionando...
<div class="form"><input type="hidden" id="comment" name="comment" value="<strong>Ticket transferido a Rocío por <?php echo $user_identity; ?>. Timestamp: <?php echo date(DATE_RFC822); ?></strong>"></div>
