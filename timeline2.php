...
$completeday = 86400;
		...
		if ( $lastday == $day ) continue;
            ...
            echo '<div class="event">';
                ...
                if ($lastmonth != $month){
                	if ($month == '01') $muestrames = 'Enero';
                	if ($month == '02') $muestrames = 'Febrero';
                	if ($month == '03') $muestrames = 'Marzo';
                	if ($month == '04') $muestrames = 'Abril';
                	if ($month == '05') $muestrames = 'Mayo';
                	if ($month == '06') $muestrames = 'Junio';
                	if ($month == '07') $muestrames = 'Julio';
                	if ($month == '08') $muestrames = 'Agosto';
                	if ($month == '09') $muestrames = 'Septiembre';
...
if ($cerrado != '0'):
			...
			if ($entrega[0] != ''){
				...
				<div class="content">
					<div class="body">'.($event['type']=='image'?'<div style="text-align:center"><img src="'.$event['body'].'" alt="Image" /></div>':nl2br($post['post_content'])).'<br /><br /><a href="'.$post['guid'].'" target="new">'.$post['guid'].'</a></div>
