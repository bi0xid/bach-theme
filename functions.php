...
function status( $term_id ){
	...
	foreach ($objetos as $objeto){
		$contopen = $wpdb->get_var("SELECT COUNT(*)  FROM wp_term_relationships WHERE object_id = '$objeto' and term_taxonomy_id = 68");
		$contwait = $wpdb->get_var("SELECT COUNT(*)  FROM wp_term_relationships WHERE object_id = '$objeto' and term_taxonomy_id = 67");
		$contclosed = $wpdb->get_var("SELECT COUNT(*)  FROM wp_term_relationships WHERE object_id = '$objeto' and term_taxonomy_id = 66");
